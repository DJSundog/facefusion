// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OldFaceTrackingViewer.xaml.cs" company="Microsoft">
...
namespace FaceFusion.Views
{
    ...
    /// tracked skeletons
    /// </summary>
    public partial class OldFaceTrackingViewer : UserControl, IDisposable
    {
        public static readonly DependencyProperty KinectProperty = DependencyProperty.Register(
            "Kinect",
            typeof(KinectSensor),
            typeof(OldFaceTrackingViewer),
            new PropertyMetadata(
                null, (o, args) => ((OldFaceTrackingViewer)o).OnSensorChanged((KinectSensor)args.OldValue, (KinectSensor)args.NewValue)));
        ...
        public OldFaceTrackingViewer()
        {
            this.InitializeComponent();
        }

        ~OldFaceTrackingViewer()
        {
            this.Dispose(false);
        }
        ...
        private void OnAllFramesReady(object sender, AllFramesReadyEventArgs allFramesReadyEventArgs)
        {
            ...
            try
            {
                ...
                foreach (var tracker in regionFaceTrackers)
                {
                    ...
                    {
                        tracker.OnFrameReady(this.Kinect, colorImageFormat, colorImage, depthImageFormat, depthImage, null);
